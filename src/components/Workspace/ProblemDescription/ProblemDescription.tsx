...
import { AiFillLike, AiFillDislike, AiOutlineLoading3Quarters, AiFillBook, AiFillStar , AiFillMeh , AiFillFire} from "react-icons/ai";
import { BsCheck2Circle } from "react-icons/bs";
import { TiStarOutline, TiBookmark, TiBook } from "react-icons/ti";
...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({ problem, _solved }) => {
	...
	return (
		<div className="bg-dark-layer-2 ">
			<div className='bg-dark-layer-1 ml-2 mr-2'>
				{/* TAB */}
							...
							{!loading && currentProblem && (
								<div className='flex items-center mt-3'>
									...
									<div
										...
										onClick={handleLike}
									>
										{liked && !updating && <AiFillFire className='text-orange-500' />}
										{!liked && !updating && <AiFillFire />}
									...
									>
										{disliked && !updating && <AiFillDislike className='text-pink-500' />}
									...
									<div
										...
										onClick={handleStar}
									>
										{starred && !updating && <AiFillBook className='text-lime-500' />}
										{!starred && !updating && <TiBookmark />}
										{updating && <AiOutlineLoading3Quarters className='animate-spin' />}
									</div>
								</div>
							)}
